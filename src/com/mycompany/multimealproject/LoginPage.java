...
public class LoginPage extends JFrame {
    ...
    private void handleLogin() {
        ...
        if (username.isEmpty() || password.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please fill in all fields.", "Login Error",
        ...
        try (Connection connect = AppConfig.getConnection();
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(this, "Invalid credentials (check case-sensitivity) or incorrect role.",
