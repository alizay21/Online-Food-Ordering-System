...
public class SignUpPage extends JFrame {
    ...
    if (name.length() < 3 || name.contains(" ")) {
        JOptionPane.showMessageDialog(this, "Username must be at least 3 characters and contain no spaces.", "Validation Error", JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    if (!pass.equals(confirmPass)) {
          JOptionPane.showMessageDialog(this, "Passwords do not match exactly (check uppercase/lowercase).", "Validation Error", JOptionPane.ERROR_MESSAGE);
          return;
    }
