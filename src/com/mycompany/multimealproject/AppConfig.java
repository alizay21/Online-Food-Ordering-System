...
public class AppConfig {
    ...
    public static final Font FONT_INPUT = new Font("Arial", Font.PLAIN, 16);
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "JDBC Driver not found. Ensure the MySQL Connector JAR is added to Libraries.", "DB Setup Error",
                    JOptionPane.ERROR_MESSAGE);
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Connection failed. Check XAMPP MySQL and database 'multimeal_db'.",
    ...
    // Expects a relative path under the project root, e.g.
